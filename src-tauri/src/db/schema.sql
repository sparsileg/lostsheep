...
-- Road graph (issue #7) moved out of this file entirely (issue #39) — it
-- now lives in its own plain SQLite file (roads.db, alongside this DB),
-- with its own schema in db/roads_schema.sql. No road_nodes/road_edges
-- tables here anymore; do not re-add them.
